...
namespace Spritely.Redo.Test
{
    ...
    public class RetriableFunctionTest
    {
        ...
        public void Constructor_throws_on_invalid_arguments()
        {
            ...
            Action(() => new RetriableFunction<object>(null, maxRetries, report, exceptionsToRetry, exceptionsToThrow, operation)).ShouldThrow<ArgumentNullException>();
            Action(() => new RetriableFunction<object>(getDelay, 0, report, exceptionsToRetry, exceptionsToThrow, operation)).ShouldThrow<ArgumentOutOfRangeException>();
            Action(() => new RetriableFunction<object>(getDelay, -1, report, exceptionsToRetry, exceptionsToThrow, operation)).ShouldThrow<ArgumentOutOfRangeException>();
            Action(() => new RetriableFunction<object>(getDelay, maxRetries, null, exceptionsToRetry, exceptionsToThrow, operation)).ShouldThrow<ArgumentNullException>();
            Action(() => new RetriableFunction<object>(getDelay, maxRetries, report, null, exceptionsToThrow, operation)).ShouldThrow<ArgumentNullException>();
            Action(() => new RetriableFunction<object>(getDelay, maxRetries, report, exceptionsToRetry, null, operation)).ShouldThrow<ArgumentNullException>();
            Action(() => new RetriableFunction<object>(getDelay, maxRetries, report, exceptionsToRetry, exceptionsToThrow, null)).ShouldThrow<ArgumentNullException>();
        }
