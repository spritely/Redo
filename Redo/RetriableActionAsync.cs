...
#pragma warning disable 0436
    ...
    internal partial class RetriableActionAsync
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetriableActionAsync"/> class.
        /// </summary>
        ...
        public async Task Now()
        {
            ...
            while (true)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    var shouldThrow = exceptionsToThrowOn.Any(t => t.GetTypeInfo().IsAssignableFrom(ex.GetType().GetTypeInfo()));

                    // If there are no exception handlers then handle all exceptions by default
                    var shouldHandle = !exceptionsToRetryOn.Any() ||
                                       exceptionsToRetryOn.Any(t => t.GetTypeInfo().IsAssignableFrom(ex.GetType().GetTypeInfo()));
